...
class Drivers_model extends CI_Model{
	...
	public function add_drivers($data) { 
		...
		$data['d_license_expdate'] = date("Y-m-d", strtotime($data['d_license_expdate']));
		$data['d_doj'] = date("Y-m-d", strtotime($data['d_doj']));
	...
	public function edit_driver() { 
		...
		$_POST['d_license_expdate'] = date("Y-m-d", strtotime($_POST['d_license_expdate']));
		$_POST['d_doj'] = date("Y-m-d", strtotime($_POST['d_doj']));
