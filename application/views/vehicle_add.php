                ...
                <div class="card-body">
                  ...
                  <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" required="" name="v_reg_exp_date" value="<?php echo (isset($vehicledetails)) ? date(dateformat(), strtotime($vehicledetails[0]['v_reg_exp_date'])):'' ?>" class="form-control datepicker" placeholder="Registration Expiry Date">
                      </div>
                  </div>
                   <div class="col-sm-6 col-md-3">
                      <div class="form-group">
